...
> You can experiment with our [playground repo template](https://github.com/tryon-technology/copybara-playground) to try various scenarios before you implement it in your own repo.
